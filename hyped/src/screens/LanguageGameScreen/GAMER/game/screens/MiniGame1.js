...
const greenAlien = require('../../Assets/alien_green.png');
const redAlien = require('../../Assets/alien.png');
const blueAlien = require('../../Assets/alien_blue.png');
const cageImage = require('../../Assets/cage.png');
const laughingAlienLeft = require('../../Assets/meteorite_left.png');
const laughingAlienRight = require('../../Assets/meteorite_right.png');


const backgroundMusicFile = require('../../Assets/background_music_alien.mp3');
const lifeLostSoundFile = require('../../Assets/life_lost.mp3');
const catchSoundFile = require('../../Assets/click.mp3');
const gameWinSoundFile = require('../../Assets/good_job.mp3');
const bachooSoundFile = require('../../Assets/bachao.mp3');
const laughingSoundFile = require('../../Assets/alienslaughing.mp3');
