...
const dropSoundFile = require('../drop_sound.mp3');
const taskCompleteSoundFile = require('../click.mp3');
...
const MiniGame2 = ({ route }) => {
  ...
  const initialLeaves = [
    { id: 1, pos: { top: 20, left: 30 }, image: require('../debris_3.png') },
    { id: 2, pos: { top: 90, left: 180 }, image: require('../debris_1.png') },
    { id: 3, pos: { top: 190, left: 20 }, image: require('../debris_2.png') },
    { id: 4, pos: { top: 150, left: 90 }, image: require('../debris_3.png') },
    { id: 5, pos: { top: 30, left: 150 }, image: require('../debris_4.png') },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.gameContainer}>
        <ImageBackground
            source={require('../minigame_background.jpg')}
